    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Integrating with VichUploaderBundle', link: '/cookbook/integration-vich-uploader' },
          { text: 'Integrating with Sonata Media Bundle', link: '/cookbook/integration-sonata-media' },
          { text: 'Integrating with EasyAdminBundle', link: '/cookbook/integration-easyadmin' },
        ],
      },
      { text: 'API Reference', link: '/api' },
    ],
